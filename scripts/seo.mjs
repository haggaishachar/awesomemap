/**
 * Builds a sitemap.xml document listing the landing page plus one entry
 * per domain page. `slugs` is the list of domain slugs (e.g.
 * `["data-science", "security"]`); `siteUrl`/`basePath` combine the same
 * way they do for `og:url` elsewhere in the generator. Embed pages
